...
// // import profilePic from '../assets/crop image.jpg'; // Adjust the path as necessary
// // import resume from '../assets/resume-example.pdf'; // Adjust the path as necessary
// // import 'animate.css';
...
// //         className="w-48 h-48 md:w-80 md:h-80 rounded-full mb-6 md:mb-0 md:mr-12"
// //       />
// //       <div className="text-center md:text-left md:ml-12 space-y-4 mt-8 md:mt-0">
// //         <p className="text-lg font-semibold">Hello, I'm</p>
// //         <h1 className="text-4xl font-bold">Disha Singh</h1>
